...
public readonly partial struct Fixed32(int rawValue) : IFixedPoint<Fixed32>
{
	...
	{
		[FieldOffset(0)]
		public readonly int sourceValue = sourceValue;
		
		[FieldOffset(0)]
		public readonly uint castedValue;
	}
	...
	{
		[FieldOffset(0)]
		public readonly uint sourceValue = sourceValue;
		
		[FieldOffset(0)]
		public readonly int castedValue;
	}
